...
async function fetchCountries() {
  ...
  allCountries = json.map((country) => {
    const { numericCode, translations, population, flag, formattedPopulation } = country;
    return {
      id: numericCode,
...
function handleCountryButtons() {
  ...
  countryButtons.forEach((button) => {
    button.addEventListener('click', () => addToFavorities(button.id));
  });
